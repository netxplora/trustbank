            ...
            return (
              ...
              <div className="bg-card rounded-xl border border-border/60 p-3.5 sm:p-4 shadow-sm transition-all h-full">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-5 gap-2.5 mb-3 p-3 bg-muted/10 border border-border/40 rounded-lg">
                  ...
                  <div><p className="text-[9px] font-bold uppercase tracking-wider text-muted-foreground mb-0.5">Outstanding</p><p className="text-xs font-mono font-bold text-foreground">${loan.outstanding_balance != null ? Number(loan.outstanding_balance).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : "\u2014"}</p></div>
                  <div><p className="text-[9px] font-bold uppercase tracking-wider text-muted-foreground mb-0.5">Monthly</p><p className="text-xs font-mono font-bold text-foreground">${loan.monthly_payment != null ? Number(loan.monthly_payment).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : "\u2014"}</p></div>
