...
const SavingsPage = () => {
  ...
  return (
    <>
      ...
      {/* Account Portfolios */}
      <section className="py-12 sm:py-20 lg:py-28 bg-background relative" id="portfolios">
                ...
                <div
                  className={`rounded-2xl sm:rounded-3xl border p-5 sm:p-8 flex flex-col h-full transition-all duration-300 hover:-translate-y-1 group ${
                    product.highlighted
                      ...
                      : "bg-card border-border hover:shadow-lg hover:border-secondary/20 shadow-sm"
                  }`}
                >
                  ...
                  {product.highlighted && (
                    <div className="absolute top-0 inset-x-0 flex justify-center -translate-y-1/2">
                      <span className="bg-secondary text-primary-foreground text-[9px] sm:text-[10px] font-bold tracking-[0.15em] uppercase px-3.5 py-1 rounded-full shadow-lg">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mb-4 flex items-baseline">
                      <span
                        className={`text-4xl sm:text-5xl lg:text-6xl font-poppins font-bold tracking-tighter ${
                      ...
                      <span
                        className={`text-base sm:text-lg ml-2 font-bold tracking-widest ${
                          product.highlighted
                            ? "text-secondary"
                            : "text-secondary/80"
                        }`}
              ...
              <StaggerItem key={scenario.title}>
                <div className="bg-background p-5 sm:p-8 rounded-2xl sm:rounded-3xl border border-border shadow-sm h-full flex flex-col hover:shadow-lg hover:border-secondary/30 transition-all duration-300 group">
                  <div className="h-11 w-11 sm:h-14 sm:w-14 rounded-xl sm:rounded-2xl bg-secondary/10 flex items-center justify-center mb-5 sm:mb-8 group-hover:scale-105 group-hover:bg-secondary/20 transition-all duration-300">
                    <scenario.icon className="h-5 w-5 sm:h-7 sm:w-7 text-secondary" />
                  </div>
                  <h3 className="text-base sm:text-lg font-poppins font-bold text-foreground mb-3 leading-snug group-hover:text-secondary transition-colors">{scenario.title}</h3>
