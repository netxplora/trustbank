              ...
              <div className="space-y-12">
                {cmsPage.content_blocks.map((block: any, idx: number) => {
                  ...
                  if (block.type === "features") {
                    return (
                      <div key={block.id || idx} className="bg-slate-50 border rounded-3xl p-6">
                ...
                <div className="container px-4 sm:px-6 lg:px-8 max-w-5xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                    {features.map((feature, i) => (
                      <div key={i} className="flex gap-4 items-start bg-card/40 border border-muted/30 rounded-3xl p-5">
              ...
              <section className="py-20 bg-surface border-b">
                <div className="container px-4 sm:px-6 lg:px-8 max-w-5xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-12">
                    {steps.map((step, i) => (
                      <div key={i} className="bg-card border border-muted/40 rounded-3xl p-5 relative shadow-sm flex flex-col justify-between">
                        <div>
                ...
                <div className="container px-4 sm:px-6 lg:px-8 max-w-4xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {securityPoints.map((p, i) => (
                      <div key={i} className="flex gap-3 bg-white/5 border border-white/10 rounded-3xl p-5 items-start">
                ...
                <div className="container px-4 sm:px-6 lg:px-8 max-w-3xl">
                  ...
                  <div className="space-y-4 mt-12">
                    {faqs.map((faq, i) => {
                      ...
                      return (
                        <div key={i} className="border border-muted/50 rounded-3xl overflow-hidden bg-card transition-all shadow-sm">
                          <button
