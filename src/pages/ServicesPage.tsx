...
const advisoryTiers = [
  {
    ...
    minimum: "$250,000",
    fee: "0.85%",
    description: "Professional portfolio management and regular reviews with a dedicated advisor. Ideal for growing your wealth.",
    features: [
  ...
  },
  {
    ...
    minimum: "$1,000,000",
    fee: "0.65%",
    description: "Custom investment strategies including stocks, bonds, and alternative investments tailored to your needs.",
    features: [
  ...
  },
  {
    ...
    minimum: "$10,000,000",
    fee: "0.45%",
    description: "Comprehensive wealth management including trust services, estate planning, and charitable giving.",
    features: [
...
const investmentHubs = [
  {
    ...
    description: "Learn how to diversify your investments to balance risk and return."
  },
  {
    icon: Activity,
    title: "Macroeconomic Market Trends",
    description: "Access expert insights on market trends, interest rates, and global investments."
  },
  {
    icon: Landmark,
    title: "Retirement & Estate Planning",
    description: "Get help navigating taxes and estate planning to protect your family's financial security."
  }
];
  ...
  return (
    <>
      <PageHero 
        ...
        description="Professional asset management, tax planning, and wealth protection. Work with our wealth managers to manage and protect your money."
        image={heroServices} 
          ...
          <StaggerContainer className="space-y-4 mt-12">
            {faqs.map((faq, i) => (
              <StaggerItem key={faq.id || i}>
                <div className="border border-muted/50 rounded-3xl overflow-hidden bg-card hover:border-primary/25 transition-all shadow-sm">
                  <button
