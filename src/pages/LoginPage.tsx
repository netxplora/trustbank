    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-12 relative overflow-hidden bg-slate-950">
        ...
        <div className="max-w-md text-center relative z-10">
          ...
          <h2 className="text-3xl font-poppins font-bold text-white mb-4">Secure Login</h2>
          <p className="text-white/70 mb-8 font-sans">Log in to manage your accounts, transfer funds, and access our services.</p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-8 bg-background">
        <div className="w-full max-w-md">
          ...
          {resetMode ? (
            ...
            <>
              <h1 className="text-2xl font-poppins font-bold text-foreground mb-2">Log In</h1>
              <p className="text-muted-foreground mb-8 font-sans">Enter your email and password to access your account.</p>
