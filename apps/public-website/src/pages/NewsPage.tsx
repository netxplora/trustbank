...
const fallbackArticles: Post[] = [
  { id: "fb-1", slug: "trustbank-enhanced-corporate-api", title: "TrustBank Unveils Enhanced Corporate API Infrastructure", summary: "Experience unified control over your treasury with our redesigned digital suite, allowing for automated SWIFT transfers and real-time ledger reconciliation directly through your ERP.", content: "", published_at: "2026-06-20T08:00:00Z", category: "Corporate Announcements", status: "published", image_url: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&q=80&w=600" },
