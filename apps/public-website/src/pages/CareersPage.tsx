...
const values = [
  { icon: Scale, title: "Absolute Discretion", description: "Our clients trust us with their most sensitive financial and corporate strategies. We maintain airtight confidentiality and operate with absolute discretion in all engagements." },
  { icon: Shield, title: "Fiduciary Excellence", description: "We act in the sole best interest of our clients, free from conflicts of interest. Our investment frameworks are built on robust quantitative analysis and risk mitigation." },
  { icon: TrendingUp, title: "Meritocratic Progression", description: "Performance dictates advancement. We evaluate personnel strictly on the tangible value they deliver to our clients and the structural integrity of their work." },
  { icon: Banknote, title: "Systematic Discipline", description: "We rely on algorithmic precision and rigorous underwriting processes rather than speculative sentiment, ensuring reliable capital preservation and growth." }
];
...
const CareersPage = () => {
  return (
    <>
      <PageHero 
        title="Institutional Careers & Leadership" 
        description="Join a distinguished cadre of relationship managers, quantitative analysts, and security architects. Build your legacy at a firm defined by uncompromising standards." 
        image={heroCareers} 
        primaryCtaText="View Open Positions"
        primaryCtaLink="#openings"
        secondaryCtaText="Read Compensation Philosophy"
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="bg-white/5 border border-white/10 p-10 md:p-16 rounded-3xl backdrop-blur-md shadow-2xl">
              <p className="text-lg md:text-xl text-white/90 font-sans leading-relaxed">
                We do not believe in capping potential. TrustBank recruits the top 1% of financial and engineering talent globally, and our compensation structures reflect that standard. We offer aggressive base salaries benchmarked above industry averages, uncapped performance bonuses tied directly to audited client yield, and direct equity participation for senior partners. We expect excellence, and we reward it unequivocally.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-32 bg-muted/30 border-y border-border">
        <div className="container px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            title="Institutional-Grade Perks"
            description="Our benefits package is designed to provide absolute peace of mind, allowing you to focus entirely on your professional mandate."
          />
