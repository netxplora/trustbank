...
const AboutPage = () => {
  return (
    <>
      ...
      <section className="py-32 bg-background relative" id="history">
          ...
          <div className="max-w-4xl mx-auto">
            <SlideUp>
              <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-3xl font-poppins font-bold text-foreground">A Legacy of Financial Prudence</h2>
              </div>
              
              <div className="prose prose-slate dark:prose-invert max-w-none">
                <p className="text-lg leading-relaxed text-muted-foreground mb-8 font-sans">
                ...
                <div className="bg-card p-8 rounded-3xl border border-border shadow-sm mb-8 mt-12">
                  <p className="text-lg leading-relaxed text-foreground font-poppins font-medium">
      ...
      <section className="py-32 bg-slate-50 dark:bg-slate-900/30 border-y border-border">
        <div className="container px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-stretch max-w-7xl mx-auto">
            <SlideUp className="h-full">
              <div className="bg-background rounded-3xl p-12 border border-border shadow-sm flex flex-col justify-between h-full hover:shadow-xl hover:border-primary/20 transition-all duration-500 group relative overflow-hidden">
                <div className="absolute -top-24 -right-24 w-64 h-64 bg-primary/5 rounded-full blur-[60px] group-hover:bg-primary/10 transition-colors duration-500" />
                <div className="relative z-10">
                  <div className="flex items-center gap-6 mb-10">
                    ...
                    <h2 className="text-3xl font-poppins font-bold text-foreground">Corporate Mission</h2>
                  </div>
            ...
            <SlideUp className="h-full" delay={0.15}>
              <div className="bg-background rounded-3xl p-12 border border-border shadow-sm flex flex-col justify-between h-full hover:shadow-xl hover:border-secondary/20 transition-all duration-500 group relative overflow-hidden">
                <div className="absolute -top-24 -right-24 w-64 h-64 bg-secondary/5 rounded-full blur-[60px] group-hover:bg-secondary/10 transition-colors duration-500" />
                <div className="relative z-10">
                  <div className="flex items-center gap-6 mb-10">
                    <div className="h-16 w-16 rounded-2xl bg-secondary/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
                      <Eye className="h-8 w-8 text-secondary" />
                    </div>
                    <h2 className="text-3xl font-poppins font-bold text-foreground">Strategic Vision</h2>
                  </div>
                  <p className="text-muted-foreground leading-relaxed font-sans text-lg">
