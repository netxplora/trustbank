...
const CheckingPage = () => {
  ...
  return (
    <>
      ...
      {/* Account Tiers */}
      <section className="py-32 bg-background relative" id="products">
              ...
              <StaggerItem key={product.name}>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mb-6">
                      <span
                        className={`text-5xl font-poppins font-bold tracking-tight ${
                          product.highlighted ? "text-white" : "text-foreground"
                        }`}
                      >
                        {product.monthlyFee}
          ...
          <StaggerContainer className="grid md:grid-cols-3 gap-8 mt-16 max-w-7xl mx-auto">
            {scenarios.map((scenario, idx) => (
              <StaggerItem key={scenario.title}>
                <div className="bg-background p-10 rounded-3xl border border-border shadow-sm h-full flex flex-col hover:shadow-xl hover:border-primary/20 transition-all duration-500 group">
                  <div className="h-14 w-14 rounded-2xl bg-primary/5 flex items-center justify-center mb-8 group-hover:scale-110 group-hover:bg-primary/10 transition-all duration-500">
      ...
      <section className="py-24 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="container px-4 sm:px-6 lg:px-8 relative z-10 text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-primary-foreground/80 font-sans mb-10 leading-relaxed">
            Transition your corporate or personal checking to TrustBank today and experience true financial control.
          </p>
