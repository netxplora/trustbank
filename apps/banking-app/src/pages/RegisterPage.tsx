...
const benefits = [
  ...
  "Secure FIDO2 Authentication",
  "Instant Wire Settlements",
    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-12 relative overflow-hidden bg-slate-950">
        ...
        <div className="max-w-md relative z-10">
          ...
          <h2 className="text-3xl font-poppins font-bold text-white mb-4">Establish Institutional Account</h2>
          <p className="text-white/70 mb-8 font-sans">Initiate your corporate or private wealth onboarding process. Subject to rigorous KYC/AML verification.</p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-8 bg-background">
        <div className="w-full max-w-md">
          ...
          <h1 className="text-2xl font-poppins font-bold text-foreground mb-2">Account Origination</h1>
          <p className="text-muted-foreground mb-8 font-sans">Provide your primary details to commence the identity verification process.</p>
