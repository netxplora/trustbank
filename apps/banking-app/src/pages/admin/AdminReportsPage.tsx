...
const reportTypes = [
  { id: "financial", title: "Institutional Financial Report", description: "Revenue, expenditures, and capital summary", icon: "📊" },
  { id: "customer", title: "Client Demographics", description: "Profile acquisition and portfolio trends", icon: "👥" },
  { id: "transaction", title: "Global Ledger Volume", description: "Inbound and outbound transaction values", icon: "💳" },
  { id: "loan", title: "Credit Facility Summary", description: "Underwriting, disbursements, and principal performance", icon: "📈" },
];
...
const AdminReportsPage = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold font-poppins text-foreground mb-1">Analytical Reports & Ledger</h1>
        <p className="text-sm text-muted-foreground font-sans">Real-time platform metrics and institutional reporting</p>
      </div>

      <StaggerContainer className="grid grid-cols-1 md:grid-cols-4 gap-4 font-sans mb-6">
        <StaggerItem>
          <div className="bg-card rounded-xl border p-6 shadow-sm h-full">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold">{stats.users.toLocaleString()}</h3>
              </div>
        ...
        <StaggerItem>
          <div className="bg-card rounded-xl border p-6 shadow-sm h-full">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-muted-foreground mb-1">Global Ledger Volume</p>
                <h3 className="text-2xl font-bold">${stats.volume.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
              </div>
        ...
        <StaggerItem>
          <div className="bg-card rounded-xl border p-6 shadow-sm h-full">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-muted-foreground mb-1">Assets Under Mgmt</p>
                <h3 className="text-2xl font-bold">${stats.aum.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
              </div>
              <div className="h-10 w-10 bg-success/10 rounded-lg flex items-center justify-center">
                <DollarSign className="h-5 w-5 text-success" />
              </div>
        ...
        <StaggerItem>
          <div className="bg-card rounded-xl border p-6 shadow-sm h-full">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-muted-foreground mb-1">Credit Facilities</p>
                <h3 className="text-2xl font-bold">${stats.loans.toLocaleString("en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</h3>
              </div>
      ...
      <StaggerContainer className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <StaggerItem>
          <div className="bg-card rounded-xl border p-6 h-full">
            <h2 className="font-bold font-poppins text-foreground mb-4">Global Ledger Volume (YTD)</h2>
            <div className="h-64">
