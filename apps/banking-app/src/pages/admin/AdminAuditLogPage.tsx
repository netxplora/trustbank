  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold font-poppins text-foreground mb-1">System Audit Logs</h1>
          <p className="text-sm text-muted-foreground font-sans">Review and track all administrative actions and system events.</p>
        </div>
      </div>

      <SlideUp className="bg-card border rounded-xl shadow-sm flex flex-col h-[75vh]">
                  ...
                  return (
                    <tr key={log.id} className={`transition-colors ${isDbTrigger ? "bg-destructive/5 hover:bg-destructive/10" : "hover:bg-muted/10"}`}>
                      ...
                      <td className="px-6 py-3">
                        {isDbTrigger ? (
                          <span className="text-[10px] uppercase font-bold text-destructive bg-destructive/20 border border-red-200 px-2 py-0.5 rounded-full flex w-max items-center gap-1">
